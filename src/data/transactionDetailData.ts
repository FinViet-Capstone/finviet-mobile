...
export const TX_DETAIL_STRINGS = {
  ...
  transferBanner:
    "Đây là giao dịch chuyển quỹ. Một số trường không thể chỉnh sửa.",
  ...
  aiSuggestOffTitle: "Phân loại bằng AI đang tắt",
  aiSuggestOffMsg: "Bạn đã tắt phân loại bằng AI trong Cài đặt. Bật lại để nhận gợi ý danh mục, hoặc chọn thủ công.",
